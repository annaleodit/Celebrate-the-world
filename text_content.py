...
"""
    ...
    "fruit_burst": {
        ...
        "desc": "Динамичная композиция из 12 фруктов, застывших в полете. 12 круглых фркутов - символ богатсва и процеветания, они будут на ка каждом столе на Филиппинах в Новогодню ночь!",
        "prompt": """
...
"""
    ...
    "light_abstract": {
        ...
        "desc": "Роскошная абстрактная композиция из размытых световых сфер. Элегантная и праздничная атмосфера. Круглые сферы символлизируют монеты, это обещение процветания и богаства в новом году.",
        "prompt": """
